...
// BuildAtomicBEEF wraps a mined transaction and its merkle proof (a BUMP, as arcade returns it
// in merklePath) into the atomic BEEF that a BRC-100 wallet's InternalizeAction requires.
//
